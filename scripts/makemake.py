...
def render_module(mod):
    ...
    # This adds -lgcov, whith neither works nor is necessary for Clang on
    # macOS. I suspect it's required for Linux, so I'll need to figure out how
    # to write a platform-specific rule for this. In the meantime, this is
    # commented out.
    #
    # if mod.program:
    #    parts.append(render_listvar(
    #        mod.program + '_LDADD',
    #        ['$(CODE_COVERAGE_LIBS)'], is_concat=True))
    # else:
    #    parts.append(render_listvar(
    #        'lib' + mod.library + '_la_LIBADD',
    #        ['$(CODE_COVERAGE_LIBS)'], is_concat=True))
